...
public class IntStream01 {
    ...
    public static void main(String[] args) {
        ...
        IntStream.range(3, 8)//3 is inclusive, 8 is exclusive
        ...
        int prod2 = IntStream.rangeClosed(1, num).reduce(1, (t, u) -> t * u);
        ...
        //2. Way: Recommended
        int prod4 = IntStream.iterate(2, t -> t + 2)
                .limit(7)
                .reduce(1, (t, u) -> t * u);
